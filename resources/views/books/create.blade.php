...
<div>
    ...
    <form action="{{ route('books.store')}}" method="POST">
        @csrf <!-- Déplace @csrf ici pour ne pas répéter -->
                        ...
                        <div class="form-row">
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="pages" class="form-control" id="inputPages" value="{{ old('pages') }}" required>
                                    @error('pages')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="quantity" class="form-control" id="inputQuantity" value="{{ old('quantity') }}" required>
                                    @error('quantity')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
