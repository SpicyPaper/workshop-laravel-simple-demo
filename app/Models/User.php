...
// TODO-8-0 Créer un modèle "Author" et sa migration en une seule commande --> php artisan make:model --migration
// TODO-8-1 Ajouter un champ "name" à "Author" et migrer les changements --> php artisan migrate

// TODO-8-2 Relier "Book" et "Author" à l'aide d'une clée étrangère nommée "author_id" dans la table "Book"
//      1. Créer une migration nommée "add_author_fk_to_books" --> php artisan make:migration add_author_fk_to_books --table=books
...
//      5. Migrer les changements --> php artisan migrate

// TODO-8-3 Compléter la méthode "down" --> dropForeign + dropColumn
// TODO-8-4 Vérifier que le "down" fonctionne --> php artisan migrate:rollback
